    ...
    <RootLayout>
      <>
        ...
        <div className="items-center justify-center my-8">
            <button className="btn btn-xs sm:btn-sm md:btn-md lg:btn-lg ml-[32rem] mr-4">취소</button>        
            <button className="btn bg-black btn-xs sm:btn-sm md:btn-md lg:btn-lg text-white">지원서 제출</button>
        </div>
