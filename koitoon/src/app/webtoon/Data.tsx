...
interface CardData {
  ...
  export const allCardsData: CardData[] = [
    {
      id: 1,
      image: 로열블루로즈,
    ...
    },
    {
      ...
      title: "15소녀표류기",
      content: "지중해 외딴섬에 표류된 소녀들의 기상천외한 섹시스토리 지친 당신의 영혼에 안식을 주는 비주얼 서스펜스 만화",
      hashtags: "#현대물 #에로틱 #하렘",
      author: "Viagra / Back",
      type: "완결작",
  ...
  서로 친 인척관계, 다양한 이해관계가 얽혀있는 오감동 주민들과 부대끼며 벌어지는 유혹과 사건 사고들. 그 안에서도 새로운 사랑은 싹 트게 되는데...각자의 마음이 오감동 마을 주민 누군가에게로 향하며 부부의 골 또한 깊어진다, 이들의 위험한 로맨스는 어떤 결론에 이를까?"`,
    ...
    },
    {
      ...
      title: "택배요",
      content: "탄탄한 중견기업 사장의 아들 기두. 방탕한 생활을 누리며, 남부러울 것 없던 삶에 큰 변화가 찾아왔다! 회사는 부도로 넘어가고..아버지는 감옥에..엄마는 행방 불명.. 한순간에 택배기사가 되고마는데!",
      hashtags: "#택배 #만남 #일상",
      author: "마카 / 청유자",
      type: "완결작",
